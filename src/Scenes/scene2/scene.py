...
def _overview_text() -> str:
    return (
        ...
        "die neu entdeckte Kristallhöhle im Nordgrat erschließen darf.\n\n"
        ...
        "dass eine zu starke Gilde den Hof erpressbar macht.\n\n"
        ...
        "im Weg steht, wird öffentlich als Feigling dargestellt.\n\n"
        ...
        "niemand tief genug in die Höhle.\n\n"
        ...
        "nicht nur Erz, sondern ein politisches Versprechen.\n\n"
        ...
        "seiner Mappe den Ausschlag geben könnte."
    )
...
def _observation_text(choice_id: str) -> str:
    texts: dict[str, str] = {
        "observe:alena": (
            ...
            "Du merkst: Alena sucht Verbündete, aber sie duldet keine lauten "
            "Abenteurer. Wer ihr hilft, muss Ruhe und Verlässlichkeit zeigen."
        ),
        "observe:bastian": (
        ...
        "observe:runa": (
            ...
            "Du erkennst: Runa lässt sich durch Höflichkeit gewinnen, aber nicht "
...
class BallroomArrivalScene(Scene):
    ...
    def start(self) -> GameResponse:
        ...
        return make_response(
            ...
            "welche Allianz die Schürfrechte erhält. Dein persönliches Ziel "
            "bleibt bis dahin im Hintergrund. Erst wenn die Kerzen heruntergebrannt "
            "sind, zeigt sich, ob du erfolgreich warst.",
    ...
    def _handle_talk(self, choice_id: str) -> GameResponse:
        ...
        return make_response(
            ...
            "Arwed, blass und aufmerksam. Die Königin kündigt an, dass vor der "
            "letzten Beratung noch genau eine Stimme aus dem Saal gehört wird.",
            input_mode=InputMode.CHOICE,
    ...
    def _handle_royal_intermezzo(self, choice_id: str) -> GameResponse:
        ...
        return make_response(
            ...
            "Gäste dürfen hinein, aber deine Einladung reicht. Jetzt fällt die "
    ...
    def _handle_council(self, choice_id: str) -> GameResponse:
        ...
        return make_response(
            self._council_text()
            + "\n\nDie Beratung dauert länger, als alle erwartet haben. Als die "
            "Türen wieder aufgehen, sind die Kerzen kurz vor dem Erlöschen. Der "
            "Ball ist fast vorbei, aber die Verkündung steht noch aus.",
            input_mode=InputMode.CHOICE,
    ...
    def _handle_final(self, choice_id: str) -> GameResponse:
        ...
        result = "Du warst erfolgreich." if success else "Du hast dein Ziel nicht erreicht."
        return make_response(
            f"König Arwed erhebt sich. \"Die Schürfrechte gehen an die "
            f"{ALLIANCE_LABELS[self.winning_alliance]}. Keine Seite erhält alles, "
            "aber eine Seite trägt ab morgen die Verantwortung.\"\n\n"
            ...
            "liegt der Nordgrat noch immer dunkel am Horizont. Doch sein Schicksal "
            "wurde heute Nacht verändert.",
            input_mode=InputMode.NONE,
            character=self.player.get_character_data(),
    ...
    def _talk_text(self, npc_id: str) -> str:
        texts = {
            ...
            "runa": (
                ...
                "wärmer. Sie merkt, dass du ihr Handwerk ernst nimmst."
            ),
            "caelion": (
                ...
                "Siegel und von Liedern, die nur noch ältere Elfen kennen."
            ),
            "marik": (
                ...
                "hat. Das macht einen gemeinsamen Pakt möglich."
            ),
        }
        return texts[npc_id]
    ...
    def _council_text(self) -> str:
        ...
        if self.winning_alliance == "balanced":
            return (
                ...
                "deshalb hört das Königspaar zu."
            )
        ...
        return (
            ...
            "Es wird gestritten, gezählt, verbessert und gedroht. Am Ende erkennt "
            "man an den Gesichtern, wohin sich die Entscheidung neigt."
        )
